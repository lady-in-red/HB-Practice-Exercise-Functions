...
def sign_and_parity(number):
    what_is = []
    if number > 0:
        what_is.append('Positive')
    elif number < 0:
        what_is.append('Negative')
...
def write_letter(RECIPIENT_NAME, JOB_TITLE, SENDER_NAME):
    print "Dear {}, I think you are amazing! ".format(full_title(RECIPIENT_NAME, JOB_TITLE)) + "Sincerely, {}".format(SENDER_NAME)
